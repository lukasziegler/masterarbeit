...
app.controller("StandardizedSurveyListController", function($scope, $http, config) {
...
app.controller("StandardizedSurveyCreateController", function($scope, $http, $location, config) {
...
app.controller("StandardizedSurveyEditController", function($scope, $http, $location, $routeParams, config) {
	$scope.questionnaire  = {};
