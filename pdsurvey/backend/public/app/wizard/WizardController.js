...
.controller("WizardController", function($scope, $http, $rootScope, config) {
	// Tabs for Wizard
	$scope.tabs = [
		{title:'Add Displays', template: '/app/wizard/templates/_display.html',},
		{title:'Choose Surveys', template: '/app/wizard/templates/_survey.html'},
		{title:'Manage Campaigns', template: '/app/wizard/templates/_campaign.html'},
		{title:'Publish', template: '/app/wizard/templates/_embedCode.html'}
	];
