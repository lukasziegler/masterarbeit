...
% My Process: Approach for Collecting Information
	...
	% 1) Appendix
	The first step was fairly straight forward. The papers from the appendix were read, in order to get a first overview of the current state of research. 
