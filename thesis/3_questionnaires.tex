...
\label{sec:questionnaires-categorization}
	...
	A list of other people's collections can be found here: Lewis and Sauro \cite{Lewis2013HCI} list discuss 19 questionnaires at the HCI conference, Garcia \cite{Garcia2013UXResearch} describes the SUMI, PSSUQ, and SUS questionnaire.
		...
		% > Overview of Usability and User Experience Surveys by the Universit{\'e} de Gen{\`e}ve \cite{Geneve2014Wiki}.
		% > Overview of Usability Questionnaires by the HTW Chur \cite{Chur2014Questionnaires}: ISONorm 110, ISOMetrics, AttrakDiff, UEQ, QUIS, SUMI
		% > Book by Wechsung and Naumann \cite{wechsung2008evaluation} - ``Evaluation Methods for Multimodal Systems: A Comparison of Standardized Usability Questionnaires''
