...
\label{sec:implementation:design-decisions}
	...
	% TODO: relativ schnell hat ziemlich vieles auf den MEAN stack hingewiesen, eine SPA Ansatz zu wählen, rein JavaScript basiert zu arbeiten. Im Folgenden werden wir die einzelnen Teile betrachten und jeweils Vergleiche ziehen und Alternativen anschauen.
	...
	\paragraph{Programming language}
		...
		% This already led to the thought of choosing the MEAN stack\footnote{\url{http://mean.io/} (last visited on March 26, 2015)} for the entire development.
