...
% provide summaries of group performances
% provide things like averages, means, medians, modes
% measure of how scores are spread (standard deviation)
% and frequency data
% > give the reader a clear idea of what we found
% think about how to represent it. either in text (for a few), in a graph (for medium) or a table (for many)
...
% - the text should be comprehensible without taking a look at the figures
	...
	We received a total of 57 filled in surveys, submitted via all four of the provided feedback channels. 
...
% SURVEY RESPONSES
	...
	% How LIKELY is it that you will USE THIS DEVICE AGAIN?
...
\paragraph{Interviews}: As mentioned earlier, we also conducted semi-structured interviews.
