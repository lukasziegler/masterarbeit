...
% SURVEY DATA
	...
	% NumQuestions
	% Due to the phenomena described by Alt et al. \cite{TODOTODOTODO}, we aimed to only use a minimum number of questions.
...
%%% QUALITATIVE RESULTS %%%	 > a combination of facts + evaluation
